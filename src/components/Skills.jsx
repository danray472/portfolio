  ...
  return (
    <div className="mt-10 container mx-auto p-8 bg-transparent border border-white/20 backdrop-blur-lg shadow-lg rounded-lg" id="skills">
      ...
      <div className="glassy-card p-4 shadow-lg custom-shadow border border-white rounded-lg">
          <img src={JavaScriptImage} alt="JavaScript" className="w-20 mx-auto rounded-md" />
        ...
        <div className="glassy-card p-4 shadow-lg custom-shadow border border-white rounded-lg">
          <img src={python} alt="Python" className="w-20 mx-auto rounded-md" />
        ...
        <div className="glassy-card p-4 shadow-lg custom-shadow border border-white rounded-lg">
          <img src={c} alt="C++" className="w-20 mx-auto  rounded-md" />
        ...
        <div className="glassy-card p-4 shadow-lg custom-shadow border border-white rounded-lg">
          <img src={npm} alt="NPM" className="w-20 mx-auto  rounded-md" />
        ...
        <div className="glassy-card p-4 shadow-lg custom-shadow border border-white rounded-lg">
          <img src={php} alt="PHP" className="w-20 mx-auto  rounded-md" />
